 ...
 */
public class ShapePointParser implements GeometryParser {
    
    @Override
    public Geometry parse(String featureMemberString) throws GeometryException {
        
        Geometry geometry = new Geometry();
        geometry.setType("ShapePoint");
        
        String patternString = "<SHAPE><gml:Point><gml:coordinates>(.+?)</gml:coordinates></gml:Point></SHAPE>";
