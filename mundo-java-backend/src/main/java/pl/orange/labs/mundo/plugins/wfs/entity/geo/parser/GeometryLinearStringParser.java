 ...
 */
public class GeometryLinearStringParser implements GeometryParser  {

    @Override
    public Geometry parse(String featureMemberString) throws GeometryException {
        
        Geometry geometry = new Geometry();
        geometry.setType("GeometryLinearString");
        
        String patternString = "<GEOMETRY><gml:LineString><gml:coordinates>(.+?)</gml:coordinates></gml:LineString></GEOMETRY>";
