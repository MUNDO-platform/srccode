 ...
 */
public class GeometryMultiLineStringParser implements GeometryParser {

    @Override
    public Geometry parse(String featureMemberString) throws GeometryException {
        
        Geometry geometry = new Geometry();
        geometry.setType(" GeometryMultiLineString");

        String patternString = "<gml:lineStringMember><gml:LineString><gml:coordinates>(.+?)</gml:coordinates></gml:LineString></gml:lineStringMember>";
