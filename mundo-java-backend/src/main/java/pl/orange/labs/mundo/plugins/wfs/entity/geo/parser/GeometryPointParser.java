 ...
 */
public class GeometryPointParser implements GeometryParser {
    
    @Override
    public Geometry parse(String featureMemberString) throws GeometryException {
        
        Geometry geometry = new Geometry();
        geometry.setType("GeometryPoint");
        
        String patternString = "<GEOMETRY><gml:Point><gml:coordinates>(.+?)</gml:coordinates></gml:Point></GEOMETRY>";
