 ...
 */
public class GeometryMultiPolygonParser implements GeometryParser {
    
    private static Logger LOGGER = Logger.getLogger(GeometryMultiPolygonParser.class);

    @Override
    public Geometry parse(String featureMemberString) throws GeometryException {
        
        Geometry geometry = new Geometry();
        geometry.setType("GeometryMultiPolygon");
