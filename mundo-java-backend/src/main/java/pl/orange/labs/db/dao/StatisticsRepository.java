...
/**
 * Repository class responsible for statistics.
...
public interface StatisticsRepository extends CrudRepository<Statistics, Long> {
     ...
     */
    List<Statistics> findAll(Sort sort);    
    /**
     * Returns Statistics object selected by path field.
     * @param path
     * @return Statistics
     */
    Statistics findByPath(String path);
}
