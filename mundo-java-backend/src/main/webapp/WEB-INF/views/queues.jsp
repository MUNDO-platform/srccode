...
<html ng-app="QueuesApp">
    <head>
        ...
        <script src="<c:url value="/resources/js/queues.js" />"></script>  
    </head>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="myModalLabel">Queue data</h4>
                        </div>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    <tr ng-repeat="queue in queues">
                        <td>{{queue.id}}</td>
                        <td><a href="${pageContext.request.contextPath}/gui/user/queue/{{queue.name}}">{{queue.name}}</a></td>
                        <td>{{queue.description}}</td>
                        <td>{{queue.url}}</td>
                        <td><a target="_blank" href="${pageContext.request.contextPath}/api/queue/{{queue.name}}">JSON</a></td>
                        <td>
                            <security:authorize access="hasAnyRole('ROLE_SUPERADMIN','ROLE_ADMIN')">
